...
public class Connection {
    ...
    public String start(int problemId){
        ...
        try{
            URL url = new URL(Global.BASE_URL + Global.START + "?problem=" + problemId);
    ...
    public JSONObject User(){
        ...
        String response = null;
        try{
            URL url = new URL(Global.BASE_URL + Global.User );
    ...
    public JSONObject waiting(){
        HttpURLConnection conn = null;
        JSONObject responseJson = null;
        try{
            URL url = new URL(Global.BASE_URL + Global.WAIT);
            conn = (HttpURLConnection) url.openConnection();
            conn.setRequestMethod("GET");
            conn.setRequestProperty(connAuth, TokenManager.getInstance().getToken());
            conn.setRequestProperty(connType, connJson);
    ...
    public JSONObject changeGrade(JSONArray jsonArray){
        HttpURLConnection conn = null;
        JSONObject responseJson = null;
        try{
            URL url = new URL(Global.BASE_URL + Global.WAIT);
            ...
            commands.put("commands", jsonArray);
    ...
    public JSONObject result(){
        ...
        JSONObject responseJson = null;
        try{
            URL url = new URL(Global.BASE_URL + Global.RESULT);
            conn = (HttpURLConnection) url.openConnection();
            conn.setRequestMethod("GET");
